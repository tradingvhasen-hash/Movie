...
const META_OUT = "src/lib/data/catalog-meta.ts";
...
async function main() {
  ...
  writeFileSync(
    META_OUT,
    `/** Generated by scripts/build-catalog.ts. */\nexport const CATALOG_SIZE = ${titles.length.toLocaleString("en-US").replace(/,/g, "_")};\n`
  );
